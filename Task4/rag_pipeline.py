...
Контекст:
«Эдуард, ставший падаваном, и его учитель, Иван Калинин».

Q: Кто был учителем Эдуарда?
A: Иван Калинин

Контекст:
«Именно Палкин спровоцировал кризис с Торговой федерацией на Новгород».

Q: Кто спровоцировал кризис в Новгороде?
A: Палкин

Контекст:
«В то время как королева Амидалова была правителем Новгорода».

Q: Была ли королева Амидалова правителем Тамбова?
A: Нет

Контекст:
«Юный Дартаньян тренируется на Мустафаре».

Q: Дартаньян жил в Туле?
A: Я не знаю
...
class BGERetriever(BaseRetriever):
    ...
    def _get_relevant_documents(self, query: str, *, run_manager: CallbackManagerForRetrieverRun) -> List[Document]:
        ...
        return self.vectorstore.similarity_search(query_with_instruction, k=3)  # Find 3 nearest chunks        
...
if __name__ == "__main__":
    ...
    test_queries = [
        "Кто был отцом Леонида Стрельцова?",
        "Был ли Палкин учеником Дубаева?"
    ]
